...
bernie=bernie.filter(function(item){
    return speakerCheck(item, "bernie-s");
});
...
pence=pence.filter(function(item){return speakerCheck(item, "donald-trump")});
...
rubio=rubio.filter(function(item){return speakerCheck(item, "donald-trump")});
